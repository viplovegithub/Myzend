 ...
 *
 * @ORM\Entity
 * @ORM\Table(name="bankacctype")
 * @property string $bankacctype;
 * @property int $bactypeid
 * @property int $status
 */
class BankAccountType implements InputFilterAwareInterface
{
    /**
     * @ORM\Id
    ...
    {
       $this->bankacctype = (isset($data['bankacctype'])) ? $data['bankacctype'] : NULL;
       $this->status =0;
    }
