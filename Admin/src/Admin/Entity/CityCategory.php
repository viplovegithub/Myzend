 ...
 *
 * @ORM\Entity
 * @ORM\Table(name="citycategory")
 * @property string $categoryName;
 * @property string $categoryInfo;
 * @property int $cityCategoryId;
 * @property int $status;	
 */

class CityCategory implements InputFilterAwareInterface
{
    /**
     * @ORM\Id
    ...
    protected $ctCatName;
      /**
     * @ORM\Column(name="categoryInfo",type="string")
     */
    protected $ctCatInfo;
      /**
    ...
    {
       $this->ctCatName = (isset($data['ctCatName'])) ? $data['ctCatName'] : NULL;
       $this->ctCatInfo = (isset($data['ctCatInfo'])) ? $data['ctCatInfo'] : NULL;
       $this->status =0;
    }
