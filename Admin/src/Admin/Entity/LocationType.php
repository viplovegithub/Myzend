 ...
 *
 * @ORM\Entity
 * @ORM\Table(name="locationtype")
 * @property string $locationType;
 * @property int $locationTypeId;
 * @property int $status
 */
class LocationType implements InputFilterAwareInterface
{
    /**
     * @ORM\Id
    ...
    {
       $this->locTypeName = (isset($data['locTypeName'])) ? $data['locTypeName'] : NULL;
       $this->status =0;
