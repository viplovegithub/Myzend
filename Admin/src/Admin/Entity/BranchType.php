 ...
 *
 * @ORM\Entity
 * @ORM\Table(name="branchtype")
 * @property string $branchtypename;
 * @property int $branchtypeid
 * @property int $status
 * 
 */
class BranchType implements InputFilterAwareInterface
{
    /**
     * @ORM\Id
     ...
     */
    protected $branchtypeid;
    /**
     * @ORM\Column(name="branchtypename",type="string")
     */
    ...
    {
       $this->branchtype = (isset($data['branchtype'])) ? $data['branchtype'] : NULL;
       $this->status = 0;
