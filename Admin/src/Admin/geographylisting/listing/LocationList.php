...
class LocationList extends AbstractTable
{
   ...
   //Definition of headers
    protected $headers = array(
            ...
            // 'locationId' =>     array('tableAlias' => 'loc',  'title' => 'Id' ) ,
             'locname' =>        array( 'tableAlias' => 'loc', 'title' => 'Location Name' , 'filters' => 'text'),
             'cntryName' =>        array( 'tableAlias' => 'c', 'title' => 'Country' , 'filters' => 'text'),
             'stname' =>        array( 'tableAlias' => 's', 'title' => 'State' , 'filters' => 'text'),
             'ctname' =>        array( 'tableAlias' => 'ct', 'title' => 'City' , 'filters' => 'text'),
             'locTypeName' =>        array( 'tableAlias' => 'lt', 'title' => 'Location Type' , 'filters' => 'text'),
...
'<span class="userEditOptionTxt"><a href="/admin/geography/locationedit/%s">Modify Location</a></span>'.
'<span class="userEditOptionTxt status"  id="%s"><a  href="javascript:void(0)" >Change Status</a></span>'.               
'</span>'
                         ,
            'vars' => array( 'locationId','locationId')
      ...
      <script>
        $(".status").click(function (){
            ...
            if(yes)
            {
                ...
                var myData = {textData:getValue,type:"Location"};
             $.ajax({
                type:"POST",
