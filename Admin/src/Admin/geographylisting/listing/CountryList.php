...
class CountryList extends AbstractTable
{
    ...
    protected $headers = array(
           ...
           // 'countryId' =>     array('tableAlias' => 'c',  'title' => 'Id' ) ,
            'cntryName' =>        array( 'tableAlias' => 'c', 'title' => 'Country Name' , 'filters' => 'text'),
            'status' =>     array( 'tableAlias' => 'c',  'title' => 'Status' ) ,
...
'<span class="userEditOptionTxt"><a href="/admin/geography/countryedit/%s">Modify Country</a></span>'.
 '<span class="userEditOptionTxt status"  id="%s"><a  href="javascript:void(0)" >Change Status</a></span>'.                  
'</span>'
           . '</span>' 
                         ,
            'vars' => array( 'countryId','countryId')
       ...
       <script>
        $(".status").click(function (){
            ...
            if(yes)
            {
                ...
                var myData = {textData:getValue,type:"Country"};
             $.ajax({
                type:"POST",
