...
class StateList extends AbstractTable
{
...
'<span class="userEditOptionTxt"><a href="/admin/geography/stateedit/%s">Modify State</a></span>'.
'<span class="userEditOptionTxt status"  id="%s"><a  href="javascript:void(0)" >Change Status</a></span>'.               
'</span>'
                         ,
            'vars' => array( 'stateId','stateId')
      ...
      <script>
        $(".status").click(function (){
            ...
            if(yes)
            {
                ...
                var myData = {textData:getValue,type:"State"};
             $.ajax({
                type:"POST",
